...
> *arXiv 2024*<br/>
> [**Full Paper**]() | [**Webpage**](https://github.com/pz0826/GAGS-Webpage) 
...
```shell
# SSH
git clone git@github.com:pz0826/GAGS.git --recursive
```
or
```shell
# HTTPS
git clone https://github.com/pz0826/GAGS.git --recursive
```
